...
from ai_agentic_engineer.generate_ideas import search_for_papers
from ai_agentic_engineer.llm import get_response_from_llm, extract_json_between_markers, create_client, AVAILABLE_LLMS
...
- LaTeX syntax errors
- Results section does not have a table that presents numerical results.
- Results section has empty plots that do not have the .png image file.
