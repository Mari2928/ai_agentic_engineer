...
aggregator_model = "Qwen/Qwen2.5-Coder-32B-Instruct"
...
Think through the problem step-by-step before providing the final code.
Respond with the final submission code only in string. 
DO NOT include string format with double-quotation mark ("), any text explanation, and a code block with three backticks (```).

Solve this programming problem in Python.
Respond a final submission code only in string. 
DO NOT include string format with double-quotation mark ("), any text explanation, and a code block with three backticks (```).
                """
